import{x as C,y as U,O as A,a0 as D,C as u,F as K,Q as W,z as S,K as j,N as V,M,W as F,G as Q,U as q}from"./context-DGHBqAcb.js";import{r as a,n as g,c as E,U as m}from"./if-defined-CXqWb8g2.js";import"./index-HLjf5NDi.js";import{M as O}from"./index-BRJ9ou81.js";import"./index-BMqooUzN.js";import{S as n}from"./index-BL4uPePB.js";import"./index-Amnfe0t1.js";import"./index-CBknF01K.js";import"./index-B392MsnR.js";import"./index-DoYoV-m6.js";import"./index-DMPdbm_g.js";import"./index-BH0rQMui.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(s<3?r(i):s>3?r(t,e,i):r(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let R=class extends U{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};R.styles=[Y];z([g()],R.prototype,"target",void 0);R=z([E("w3m-swap-input-skeleton")],R);const Z=C`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
