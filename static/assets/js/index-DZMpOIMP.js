import{b1 as _,b4 as R,b5 as j,aA as d,aJ as y,aB as h,aE as l,aV as c,aS as O}from"./slice-DJ_A8Uly.js";import{n as v,c as p,o as P,r as T}from"./if-defined-DJZcGMPC.js";import{e as U,n as L}from"./index-B516J_lC.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return j(u,()=>i(u))},subscribeKey(i,e){return R(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
