import{j as N,k,x as a,r as L}from"./Themecontext-DjRST77u.js";import{n as l,c as _,o as S,r as b}from"./if-defined-GXzUJKWu.js";import{T as A,D as Y}from"./index-D-dNtjti.js";import"./index-B3__XS7b.js";import"./index-_NHfPwWE.js";import"./index-UDF1Ogxz.js";import{d as v,u as p,c as O,R as V,O as z,e as E,A as W,W as F}from"./Providers-vInVlvdd.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
