import{aA as E,aB as P,aF as S,aV as b,aD as g,aI as W,aE as c,aM as u,aX as D,aO as R,aP as d,aY as T,aU as U,aR as C,aC as k,aG as y,aN as _}from"./slice-_n3LJRun.js";import{n as j,r as l,c as I,o as w}from"./if-defined-pKm18Cmw.js";import{O as L}from"./index-BFpKZVma.js";import{e as q}from"./index-BnB5TyVN.js";import"./index-D9EJrpBK.js";import"./index-De4abG9g.js";import"./index-CRSSXvEC.js";import"./index-CrGA5vnp.js";import"./index-BmckTfpt.js";import"./index-DJvLkJTi.js";import"./index-CRD8q8Nb.js";import"./index-BYr67e3e.js";const z=E`
  :host {
...
`;var x=function(a,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,i,o);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let p=class extends P{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.features=b.state.features,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("features",e=>this.features=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;let e=((t=this.features)==null?void 0:t.socials)||[];const i=!!this.authConnector,o=e==null?void 0:e.length,n=g.state.view==="ConnectSocials";return(!i||!o)&&!n?null:(n&&!o&&(e=W.DEFAULT_FEATURES.socials),c` <wui-flex flexDirection="column" gap="xs">
      ${e.map(r=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await q(e)}};p.styles=z;x([j()],p.prototype,"tabIdx",void 0);x([l()],p.prototype,"connectors",void 0);x([l()],p.prototype,"authConnector",void 0);x([l()],p.prototype,"features",void 0);p=x([I("w3m-social-login-list")],p);const N=E`
  wui-flex {
...
`;var A=function(a,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,i,o);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let $=class extends P{constructor(){super(),this.unsubscribe=[],this.checked=L.state.isLegalCheckboxChecked,this.unsubscribe.push(L.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var O;const{termsConditionsUrl:e,privacyPolicyUrl:i}=b.state,o=(O=b.state.features)==null?void 0:O.legalCheckbox,t=!!(e||i)&&!!o,r=t&&!this.checked,s=r?-1:void 0;return c`
    ...
    `}};$.styles=N;A([l()],$.prototype,"checked",void 0);$=A([I("w3m-connect-socials-view")],$);const V=E`
  wui-logo {
    width: 80px;
    height: 80px;
