import{p as _,s as R,h as j,K as d,U as y,L as h,Q as l,m as a,V as O}from"./Themecontext-Dj1Zc1Om.js";import{n as v,c as p,o as P,r as T}from"./if-defined-DtDTWw7x.js";import{e as U,n as L}from"./index-B8hp9lmX.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return j(u,()=>i(u))},subscribeKey(i,e){return R(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var z=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var c=i.length-1;c>=0;c--)(s=i[c])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let x=class extends h{render(){return l`
    ...
    `}};x.styles=[y,O,B];x=z([p("wui-ux-by-reown")],x);const D=d`
  :host > wui-flex {
