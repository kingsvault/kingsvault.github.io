import{x as R,y as k,C as a,G as Y,O as v,ac as p,N as O,z as L,Y as z,Q as V,K as E,W}from"./context-Bl8Nf2PS.js";import{n as l,c as _,o as j,r as b}from"./if-defined-5gshCqnA.js";import{T as A,D as F}from"./index-DYVFUJT7.js";import"./index-Bfz71EaO.js";import"./index-C3PFsfm8.js";import"./index-Wx63IyWi.js";var N;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
