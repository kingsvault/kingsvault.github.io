import{aA as R,aB as k,aE as a,aJ as L,aO as v,b9 as p,aN as O,aD as Y,aV as V,aP as z,aM as E,aQ as F}from"./slice-DJ_A8Uly.js";import{n as l,c as _,o as j,r as b}from"./if-defined-DJZcGMPC.js";import{T as A,D as W}from"./index-CWmTl-_m.js";import"./index-BfiRsrYC.js";import"./index-DRd_WvUD.js";import"./index-BFzzWnfL.js";var N;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
