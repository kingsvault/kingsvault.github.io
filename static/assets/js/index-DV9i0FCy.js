import{aA as p,aB as u,aD as f,aC as b,aE as d}from"./slice-DJ_A8Uly.js";import{n as g,r as m,c as v}from"./if-defined-DJZcGMPC.js";import{T as l}from"./index-Bw2OF-cd.js";const C={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=i[0]||0,r=i[1]||0,t=e[0]||0,s=e[1]||0;return o<n?t:o>r?s:(s-t)/(r-n)*(o-n)+t}},w=p`
  :host {
    width: 100%;
    display: block;
  }
