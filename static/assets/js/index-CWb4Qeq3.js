import{t as _,w as j,y as O,i as d,r as y,a as h,x as l,O as a,j as R}from"./index-CE61t1uO.js";import{n as v,c as p,o as P,r as T}from"./if-defined-DKDoNXBs.js";import{e as U,n as L}from"./index-DCBqvOoT.js";const u=_({isLegalCheckboxChecked:!1}),g={state:u,subscribe(i){return O(u,()=>i(u))},subscribeKey(i,e){return j(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var z=function(i,e,r,n){var o=arguments.length,t=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,e,r,n);else for(var c=i.length-1;c>=0;c--)(s=i[c])&&(t=(o<3?s(t):o>3?s(e,r,t):s(e,r))||t);return o>3&&t&&Object.defineProperty(e,r,t),t};let x=class extends h{render(){return l`
    ...
    `}};x.styles=[y,R,B];x=z([p("wui-ux-by-reown")],x);const D=d`
  :host > wui-flex {
