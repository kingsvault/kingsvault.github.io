import{a4 as _,a7 as R,a8 as j,x as d,G as y,y as h,C as l,Y as c,U as O}from"./context-Fw5Z10m7.js";import{n as v,c as p,o as P,r as T}from"./if-defined-Cv0LEheo.js";import{e as U,n as L}from"./index-KuSQrWb6.js";const u=_({isLegalCheckboxChecked:!1}),x={state:u,subscribe(i){return j(u,()=>i(u))},subscribeKey(i,e){return R(u,i,e)},setIsLegalCheckboxChecked(i){u.isLegalCheckboxChecked=i}},E=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
