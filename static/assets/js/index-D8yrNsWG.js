import{j as h,k as m,x as w}from"./Themecontext-DjRST77u.js";import{r as u,c as g}from"./if-defined-GXzUJKWu.js";import{p as f,s as v,o as b}from"./Providers-vInVlvdd.js";const e=f({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return b(e,()=>o(e))},subscribeKey(o,t){return v(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=h`
  :host {
    pointer-events: none;
  }
