import{K as f,L as w,n as z,g as H,Y as a,Q as u,U as W,V,R as b,v as q,X as N,d as D,w as G}from"./Themecontext-Dj1Zc1Om.js";import{n as d,r as c,c as m,U as v,o as F}from"./if-defined-DtDTWw7x.js";import{e as B,n as O}from"./index-B8hp9lmX.js";import"./index-Ch2GxPNz.js";import"./index-DPmJGDBq.js";import{S as L}from"./index-BbKQ_KlN.js";import"./index-BAnAgo67.js";import"./index-Bce8vVNb.js";import"./index-Bk0oyupj.js";import"./index-8taTtidq.js";import"./context-Db7bLoJ5.js";import"./index-3of6IRct.js";const M=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var A=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let k=class extends w{render(){return u` <wui-flex
    ...
    >`}handleSelectButtonClick(){b.push("WalletSendSelectToken")}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const i=this.token.price*this.sendTokenAmount;return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
      ...
      >`}return null}maxAmountTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u` <wui-text variant="small-400" color="error-100">
        ...
        ${v.roundNumber(Number(this.token.quantity.numeric),6,5)}
      </wui-text>`:null}actionTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u`<wui-link @click=${this.onBuyClick.bind(this)}>Buy</wui-link>`:u`<wui-link @click=${this.onMaxClick.bind(this)}>Max</wui-link>`:null}onInputChange(e){a.setTokenAmount(e.detail)}onMaxClick(){if(this.token&&typeof this.gasPrice<"u"){const e=this.token.address===void 0||Object.values(q.NATIVE_TOKEN_ADDRESS).some(r=>{var t;return((t=this.token)==null?void 0:t.address)===r}),i=N.bigNumber(this.gasPrice).div(N.bigNumber(10).pow(Number(this.token.quantity.decimals))),n=e?N.bigNumber(this.token.quantity.numeric).minus(i):N.bigNumber(this.token.quantity.numeric);a.setTokenAmount(Number(n.toFixed(20)))}}onBuyClick(){b.push("OnRampProviders")}};k.styles=X;A([d({type:Object})],k.prototype,"token",void 0);A([d({type:Number})],k.prototype,"sendTokenAmount",void 0);A([d({type:Number})],k.prototype,"gasPriceInUSD",void 0);A([d({type:Number})],k.prototype,"gasPrice",void 0);k=A([m("w3m-input-token")],k);const J=f`
  :host {
    display: block;
  }
