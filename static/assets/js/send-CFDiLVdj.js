import{aA as f,aB as w,aN as z,aU as H,a_ as a,aE as u,aJ as W,aS as V,aD as b,aI as L,aZ as N,aO as D,a$ as G}from"./slice-_n3LJRun.js";import{n as d,r as c,c as m,U as v,o as F}from"./if-defined-pKm18Cmw.js";import{e as U,n as O}from"./index-De4abG9g.js";import"./index-D9EJrpBK.js";import"./index-CRSSXvEC.js";import{S as q}from"./index-0yEI4HQk.js";import"./index-B4_CJOi5.js";import"./index-P_GSgptz.js";import"./index-BYr67e3e.js";import"./index-DJvLkJTi.js";import"./index-CRD8q8Nb.js";const M=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var A=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let k=class extends w{render(){return u` <wui-flex
    ...
    >`}handleSelectButtonClick(){b.push("WalletSendSelectToken")}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const i=this.token.price*this.sendTokenAmount;return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
      ...
      >`}return null}maxAmountTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u` <wui-text variant="small-400" color="error-100">
        ...
        ${v.roundNumber(Number(this.token.quantity.numeric),6,5)}
      </wui-text>`:null}actionTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u`<wui-link @click=${this.onBuyClick.bind(this)}>Buy</wui-link>`:u`<wui-link @click=${this.onMaxClick.bind(this)}>Max</wui-link>`:null}onInputChange(e){a.setTokenAmount(e.detail)}onMaxClick(){if(this.token&&typeof this.gasPrice<"u"){const e=this.token.address===void 0||Object.values(L.NATIVE_TOKEN_ADDRESS).some(r=>{var t;return((t=this.token)==null?void 0:t.address)===r}),i=N.bigNumber(this.gasPrice).div(N.bigNumber(10).pow(Number(this.token.quantity.decimals))),n=e?N.bigNumber(this.token.quantity.numeric).minus(i):N.bigNumber(this.token.quantity.numeric);a.setTokenAmount(Number(n.toFixed(20)))}}onBuyClick(){b.push("OnRampProviders")}};k.styles=Z;A([d({type:Object})],k.prototype,"token",void 0);A([d({type:Number})],k.prototype,"sendTokenAmount",void 0);A([d({type:Number})],k.prototype,"gasPriceInUSD",void 0);A([d({type:Number})],k.prototype,"gasPrice",void 0);k=A([m("w3m-input-token")],k);const Q=f`
  :host {
    display: block;
  }
...
`;var I=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let y=class extends w{constructor(){super(),this.unsubscribe=[],this.tokenBalances=a.state.tokenBalances,this.search="",this.onDebouncedSearch=z.debounce(e=>{this.search=e}),this.unsubscribe.push(a.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u`
    ...
    `}onBuyClick(){b.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){a.setToken(e),a.setTokenAmount(void 0),b.goBack()}};y.styles=X;I([c()],y.prototype,"tokenBalances",void 0);I([c()],y.prototype,"tokens",void 0);I([c()],y.prototype,"filteredTokens",void 0);I([c()],y.prototype,"search",void 0);y=I([m("w3m-wallet-send-select-token-view")],y);const ee=f`
  :host {
    display: flex;
