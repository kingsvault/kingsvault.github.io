import{i as N,a as k,x as a,r as L,f as v,G as p,e as O,R as Y,O as V,h as z,A as E,W}from"./index-CE61t1uO.js";import{n as l,c as _,o as j,r as b}from"./if-defined-DKDoNXBs.js";import{T as A,D as F}from"./index-DLBwbZeR.js";import"./index-nBPSM1hC.js";import"./index-CgGF82fD.js";import"./index-C_ZoF6DZ.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
