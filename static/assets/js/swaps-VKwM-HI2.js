import{i as C,a as U,f as A,N as D,x as u,c as K,h as W,R as S,A as j,e as V,M,W as F,r as Q,j as q}from"./index-CE61t1uO.js";import{r as a,n as g,c as E,U as m}from"./if-defined-DKDoNXBs.js";import"./index-DCBqvOoT.js";import{M as R}from"./index-CMzRoONi.js";import"./index-DoQmuGhU.js";import{S as n}from"./index-a4Ie7pPd.js";import"./index-Yn3GBn6f.js";import"./index-DjPbpZC5.js";import"./index-C_ZoF6DZ.js";import"./index-D1NSFOEj.js";import"./index-nBPSM1hC.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
