import{p as ie,_ as Z,B as K,l as q,d as A,C as se,A as $,$ as ne,s as oe,h as ae,K as R,L as y,Q as c,a0 as L,a1 as C,m as D,M as I,w as ce,E as ee,i as te,R as E,n as F,v as V,g as le,G as M,T as ue}from"./Themecontext-Dj1Zc1Om.js";import{n as p,c as g,o as h,r as d}from"./if-defined-DtDTWw7x.js";import{D as de,T as pe}from"./index-BCG7Y9Pa.js";import"./index-Ch2GxPNz.js";import"./index-Bk0oyupj.js";import"./index-3of6IRct.js";import"./index-aOVDm1y5.js";import{O as Y}from"./index-nLDBfjI5.js";import"./index-DPmJGDBq.js";import"./index-B8hp9lmX.js";import"./index-BAnAgo67.js";import"./index-8taTtidq.js";import"./context-Db7bLoJ5.js";import"./index-CdZckySK.js";const j={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},G={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},me={providers:Z,selectedProvider:null,error:null,purchaseCurrency:j,paymentCurrency:G,purchaseCurrencies:[j],paymentCurrencies:[],quotesLoading:!1},l=ie(me),u={state:l,subscribe(s){return ae(l,()=>s(l))},subscribeKey(s,e){return oe(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=A.state.activeChain===se.CHAIN.SOLANA?"SOL":"USDC",t=$.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",ne),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||G,l.purchaseCurrency=s.purchaseCurrencies[0]||j,await q.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await q.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=Z,l.selectedProvider=null,l.error=null,l.purchaseCurrency=j,l.paymentCurrency=G,l.purchaseCurrencies=[j],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
...
`;var B=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};const we=7;let O=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=u.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=L.state.coinbaseTransactions,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(u.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},L.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),L.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var W=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.paymentCurrency,this.currencies=u.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(a=D.state.features)==null?void 0:a.legalCheckbox,o=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return c`
      ...
      `})}selectCurrency(e){e&&(u.setPaymentCurrency(e),I.close())}};k.styles=ye;W([d()],k.prototype,"selectedCurrency",void 0);W([d()],k.prototype,"currencies",void 0);W([d()],k.prototype,"currencyImages",void 0);W([d()],k.prototype,"checked",void 0);k=W([g("w3m-onramp-fiat-select-view")],k);const ge=R`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var z=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};let S=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(a=D.state.features)==null?void 0:a.legalCheckbox,o=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),I.close())}};S.styles=xe;z([d()],S.prototype,"selectedCurrency",void 0);z([d()],S.prototype,"tokens",void 0);z([d()],S.prototype,"tokenImages",void 0);z([d()],S.prototype,"checked",void 0);S=z([g("w3m-onramp-token-select-view")],S);const Ce=R`
  @keyframes shake {
    0% {
...
`;var _=function(s,e,t,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(r=(n<3?o(r):n>3?o(e,t,r):o(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r};const Pe={USD:"$",EUR:"€",GBP:"£"},_e=[100,250,500,1e3];let x=class extends y{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=A.state.activeCaipAddress,this.loading=I.state.loading,this.paymentCurrency=u.state.paymentCurrency,this.paymentAmount=u.state.paymentAmount,this.purchaseAmount=u.state.purchaseAmount,this.quoteLoading=u.state.quotesLoading,this.unsubscribe.push(A.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),I.subscribeKey("loading",e=>{this.loading=e}),u.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
      <wui-flex flexDirection="column" justifyContent="center" alignItems="center">
        <wui-flex flexDirection="column" alignItems="center" gap="xs">
          ...
          <wui-flex justifyContent="space-evenly" class="amounts-container" gap="xs">
            ${_e.map(e=>{var t;return c`<wui-button
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||I.open({view:"OnRampProviders"})}openModal(){I.open({view:"Connect"})}async onPaymentAmountChange(e){u.setPaymentAmount(Number(e.detail)),await u.getQuote()}async selectPresetAmount(e){u.setPaymentAmount(e),await u.getQuote()}};x.styles=Ae;_([p({type:Boolean})],x.prototype,"disabled",void 0);_([d()],x.prototype,"caipAddress",void 0);_([d()],x.prototype,"loading",void 0);_([d()],x.prototype,"paymentCurrency",void 0);_([d()],x.prototype,"paymentAmount",void 0);_([d()],x.prototype,"purchaseAmount",void 0);_([d()],x.prototype,"quoteLoading",void 0);x=_([g("w3m-onramp-widget")],x);export{f as W3mBuyInProgressView,O as W3mOnRampActivityView,Q as W3mOnRampProvidersView,k as W3mOnrampFiatSelectView,S as W3mOnrampTokensView,x as W3mOnrampWidget,J as W3mWhatIsABuyView};
