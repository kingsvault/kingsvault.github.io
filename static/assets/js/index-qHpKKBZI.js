import{aA as x,aJ as _,aS as T,aB as w,aE as l,aO as d,a$ as $,aV as C,ba as ue,aM as m,aN as g,aC as A,aP as S,aY as xe,aF as b,aK as k,aD as f,aI as P,aR as D,aQ as M,aU as v,a_ as bn,aX as xn,b0 as Fi,bb as vn,bc as li,b7 as I,bd as Ae,be as Ke,aW as yn,aG as Xt,bf as Si}from"./slice-DJ_A8Uly.js";import{n as c,c as h,o as p,U as W,r as u,e as _i}from"./if-defined-DJZcGMPC.js";import"./index-BFzzWnfL.js";import"./index-D5AHBQ5N.js";import"./index-_MIOjKn4.js";import"./index-BfiRsrYC.js";import{W as hs}from"./index-fkBDjZQS.js";import"./index-CnR6_VFa.js";import"./index-_FpjhqFn.js";import{e as ci,n as ui}from"./index-B516J_lC.js";import"./index-8g3EZ8Ak.js";import"./index-DRd_WvUD.js";import{M as Ii}from"./index-DV9i0FCy.js";import"./index-Bw2OF-cd.js";import"./index-taVV0MRT.js";import"./index-BLf1eoxt.js";import"./index-DV-rvIy4.js";import{O as pt}from"./index-DZMpOIMP.js";import{e as Cn}from"./index-DrTplmPV.js";import{N as $n}from"./index-CybZkgs3.js";import"./index-D8GaipyH.js";import"./index-CN7K-22p.js";import"./index-CERX4ADX.js";import"./index-CWmTl-_m.js";const kn=x`
  :host {
    display: block;
  }
...
`;var zn=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let Jt=class extends w{render(){return l`${this.nftTemplate()}`}nftTemplate(){return l` <wui-flex
    ...
    >
      ...
      >
    </wui-flex>`}onReceiveClick(){f.push("WalletReceive")}};Jt.styles=Un;Jt=zn([h("w3m-account-nfts-widget")],Jt);const Vn=x`
  button {
    width: 100%;
    display: flex;
    gap: var(--wui-spacing-s);
...
`;var Ji=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let wt=class extends w{constructor(){super(...arguments),this.inputElementRef=ci(),this.checked=void 0}render(){return l`
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("switchChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};wt.styles=[_,T,vn,Jn];Ji([c({type:Boolean})],wt.prototype,"checked",void 0);wt=Ji([h("wui-switch")],wt);const Zn=x`
  :host {
    height: 100%;
  }
...
`;var Zi=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let ft=class extends w{constructor(){super(...arguments),this.checked=void 0}render(){return l`
    ...
    `}};ft.styles=[_,T,Zn];Zi([c({type:Boolean})],ft.prototype,"checked",void 0);ft=Zi([h("wui-certified-switch")],ft);const eo=x`
  button {
...
`;var V=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let j=class extends w{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.tabIdx=void 0,this.installed=!1,this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return l`
    ...
    `:(this.style.cssText="display: none",null)}onConnectWallet(e){this.loading||b.selectWalletConnector(e)}hasWalletConnector(e){return this.connectors.some(t=>t.id===e.id||t.name===e.name)}isWalletCompatibleWithCurrentChain(e){const t=d.state.activeChain;return t&&e.chains?e.chains.some(n=>{const o=n.split(":")[0];return t===o}):!0}};zt([c()],Je.prototype,"tabIdx",void 0);zt([u()],Je.prototype,"connectors",void 0);zt([u()],Je.prototype,"loading",void 0);Je=zt([h("w3m-connect-recent-widget")],Je);var Vt=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let Ze=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.wallets=[],this.loading=!1,g.isTelegram()&&g.isIos()&&(this.loading=!v.state.wcUri,this.unsubscribe.push(v.subscribeKey("wcUri",e=>this.loading=!e)))}render(){const{connectors:e}=b.state,{customWallets:t,featuredWalletIds:n}=C.state,o=xe.getRecentWallets(),i=e.find(N=>N.id==="walletConnect"),s=e.filter(N=>N.type==="INJECTED"||N.type==="ANNOUNCED"||N.type==="MULTI_CHAIN").filter(N=>N.name!=="Browser Wallet");if(!i)return null;if(n||t||!this.wallets.length)return this.style.cssText="display: none",null;const y=s.length+o.length,O=Math.max(0,2-y),R=Ae.filterOutDuplicateWallets(this.wallets).slice(0,O);return R.length?l`
      <wui-flex flexDirection="column" gap="xs">
        ${R.map(N=>l`
            <wui-list-wallet
              imageSrc=${p($.getWalletImage(N))}
    ...
    `:(this.style.cssText="display: none",null)}onConnectWallet(e){if(this.loading)return;const t=b.getConnector(e.id,e.rdns);t?f.push("ConnectingExternal",{connector:t}):f.push("ConnectingWalletConnect",{wallet:e})}};Vt([c()],Ze.prototype,"tabIdx",void 0);Vt([c()],Ze.prototype,"wallets",void 0);Vt([u()],Ze.prototype,"loading",void 0);Ze=Vt([h("w3m-connect-recommended-widget")],Ze);var Mt=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let et=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=b.state.connectors,this.connectorImages=ue.state.connectorImages,this.unsubscribe.push(b.subscribeKey("connectors",e=>this.connectors=e),ue.subscribeKey("connectorImages",e=>this.connectorImages=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(g.isMobile())return this.style.cssText="display: none",null;const e=this.connectors.find(n=>n.id==="walletConnect");if(!e)return this.style.cssText="display: none",null;const t=e.imageUrl||this.connectorImages[(e==null?void 0:e.imageId)??""];return l`
      <wui-list-wallet
        imageSrc=${p(t)}
        name=${e.name??"Unknown"}
...
`;var $i=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let ot=class extends w{constructor(){super(...arguments),this.icon="externalLink",this.text=""}render(){return l`
    ...
    `}};ot.styles=[_,T,Qo];$i([c()],ot.prototype,"icon",void 0);$i([c()],ot.prototype,"text",void 0);ot=$i([h("wui-banner")],ot);const Jo=x`
  :host > wui-flex {
    max-height: clamp(360px, 540px, 80vh);
    overflow: scroll;
    scrollbar-width: none;
...
`;var tr=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let si=class extends w{constructor(){var e,t;super(...arguments),this.dappImageUrl=(e=C.state.metadata)==null?void 0:e.icons,this.walletImageUrl=(t=m.state.connectedWalletInfo)==null?void 0:t.icon}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelectorAll("wui-visual-thumbnail");e!=null&&e[0]&&this.createAnimation(e[0],"translate(18px)"),e!=null&&e[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){var e;return l`
    ...
    `}async onSign(){this.isSigning=!0,await Si.requestSignMessage().finally(()=>this.isSigning=!1)}async onCancel(){this.isCancelling=!0,await Si.cancelSignMessage().finally(()=>this.isCancelling=!1)}};ki([u()],Nt.prototype,"isCancelling",void 0);ki([u()],Nt.prototype,"isSigning",void 0);Nt=ki([h("w3m-siwx-sign-message-view")],Nt);export{Ai as AppKitAccountButton,Wi as AppKitButton,Ei as AppKitConnectButton,ji as AppKitNetworkButton,Ti as W3mAccountButton,Y as W3mAccountSettingsView,Zt as W3mAccountView,bt as W3mAllWalletsView,Ri as W3mButton,It as W3mChooseAccountNameView,Ni as W3mConnectButton,K as W3mConnectView,Tt as W3mConnectWalletsView,Bi as W3mConnectingExternalView,_t as W3mConnectingMultiChainView,oi as W3mConnectingWcBasicView,it as W3mConnectingWcView,Hi as W3mDownloadsView,Ki as W3mGetWalletView,Oi as W3mNetworkButton,nt as W3mNetworkSwitchView,Se as W3mNetworksView,pe as W3mProfileView,hs as W3mRouter,Nt as W3mSIWXSignMessageView,At as W3mSwitchActiveChainView,Xe as W3mSwitchAddressView,Rt as W3mUnsupportedChainView,Wt as W3mWalletCompatibleNetworksView,Gi as W3mWhatIsANetworkView,qi as W3mWhatIsAWalletView};
