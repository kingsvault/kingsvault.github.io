import{x as w,G as g,U as x,y as u,C as n,af as t}from"./context-DGHBqAcb.js";import{n as o,c as k,o as v}from"./if-defined-CXqWb8g2.js";import"./index-B392MsnR.js";import"./index-DMPdbm_g.js";import"./index-BH0rQMui.js";const M=w`
  button {
...
`,O=t`<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;var p=function(c,e,l,r){var h=arguments.length,i=h<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,l):r,C;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,l,r);else for(var d=c.length-1;d>=0;d--)(C=c[d])&&(i=(h<3?C(i):h>3?C(e,l,i):C(e,l))||i);return h>3&&i&&Object.defineProperty(e,l,i),i};const W={browser:Z,dao:V,defi:b,defiAlt:m,eth:E,layers:H,lock:_,login:D,network:A,nft:j,noun:z,profile:U,system:T,coinbase:L,meld:S,onrampCard:$,moonpay:P,stripe:R,paypal:G,google:B,pencil:O,lightbulb:F,solana:q,bitcoin:y};let f=class extends u{constructor(){super(...arguments),this.name="browser",this.size="md"}render(){return this.style.cssText=`
