import{K as C,L as U,d as A,X as D,Q as u,v as K,E as W,R as S,A as j,n as V,M,i as F,U as Q,V as q}from"./Themecontext-B4U-m4C3.js";import{r as a,n as g,c as E,U as m}from"./if-defined-DjJUk4vj.js";import"./index-ClGO-Wxv.js";import{M as R}from"./index-BZkG_Nlg.js";import"./index-DU5nKY2M.js";import{S as n}from"./index-BF9bgjgg.js";import"./index-CUgMSRAG.js";import"./index-BzxKAtdy.js";import"./index-BgLa9WuC.js";import"./index-ZuCFZj1N.js";import"./context-B02iD4oi.js";import"./index-DR0xbsXG.js";import"./index-Ch22TaHc.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",O=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!O&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||O)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!O&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(s<3?r(i):s>3?r(t,e,i):r(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let L=class extends U{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};L.styles=[Y];z([g()],L.prototype,"target",void 0);L=z([E("w3m-swap-input-skeleton")],L);const Z=C`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
